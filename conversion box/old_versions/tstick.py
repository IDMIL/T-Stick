...
libmapper_OSC = udp_client.SimpleUDPClient('127.0.0.1', 9000)
...
def get_tstick_id(*msg):
    if msg[0] == 0:
        ...
        libmapper_OSC.send_message("/information", info_list)
        return tstick_id
...
def sort_and_send_173(*msg):
    if msg[0] == 0:
        ...
        libmapper_OSC.send_message("/rawcapsense", rawcapsense)
        ...
        libmapper_OSC.send_message("/rawaccel", [accel_x, accel_y, accel_z])
        libmapper_OSC.send_message("/rawgyro", [gyro_x, gyro_y, gyro_z])
        libmapper_OSC.send_message("/rawpressure", pressure)
        libmapper_OSC.send_message("/rawpiezo", piezo)
    elif msg[0] == 3:
        ...
        libmapper_OSC.send_message("/rawmag", [mag_x, mag_y, mag_z])
    elif msg[0] == 4:
        return 0
...
def sort_and_send_2G(*msg):
    if msg[0] == 0:
        ...
        libmapper_OSC.send_message("/rawjab", rawjab)
    elif msg[0] == 3:
        rawtap = msg[1:]
...
def sort_and_send_2GX(*msg):
    if msg[0] == 0:
        ...
        rawtap = msg[1:]
        client_OSC.send_message("/rawtap", rawtap)
        libmapper_OSC.send_message("/rawtap", rawtap)
    elif msg[0] == 4:
        accel_x = bit_conversion(msg[1], msg[2])
        accel_y = bit_conversion(msg[3], msg[4])
        accel_z = bit_conversion(msg[5], msg[6])
        ...
        libmapper_OSC.send_message("/rawpressure", pressure)
        libmapper_OSC.send_message("/rawpiezo", piezo)
        libmapper_OSC.send_message("/rawairpressure", airpressure)
        libmapper_OSC.send_message("/rawrange", tstick_range)
        libmapper_OSC.send_message("/rawldr1", ldr1)
        libmapper_OSC.send_message("/rawldr2", ldr2)
