...
/* Modified version of NewPing library
 * - added mm option (other than cm and In)
 */
...
// ---------------------------------------------------------------------------
	...
	//#define MAX_SENSOR_DELAY 60000   // Maximum uS it takes for sensor to start the ping. Default=5800
	...
	class NewPing {
		public:
			...
			unsigned long ping_mm(unsigned int max_cm_distance = 0);
