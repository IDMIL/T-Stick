...
void readData() {
  ...
  // read battery level
  // (https://www.youtube.com/watch?v=yZjpYmWVLh8&feature=youtu.be&t=88)
...
void printData() {
  if (millis() - serialLastRead > serialInterval) {
    ...
    //     for( int i = 0 ; i < (sizeof(RawData.accl)/sizeof(RawData.accl[0])) ;
    //     ++i ){
    //       Serial.print(RawData.accl[i], 10);
    //       Serial.print(" ");
    //     }
    // Serial.print("\nRawData.gyro: ");
    //     for( int i = 0 ; i < (sizeof(RawData.gyro)/sizeof(RawData.gyro[0])) ;
    //     ++i ){
    //       Serial.print(RawData.gyro[i], 10);
    //       Serial.print(" ");
    //     }
    // Serial.print("\nRawData.magn: ");
    //     for( int i = 0 ; i < (sizeof(RawData.magn)/sizeof(RawData.magn[0])) ;
    //     ++i ){
    //       Serial.print(RawData.magn[i], 10);
    //       Serial.print(" ");
    //     }
    // Serial.print("\nRawData.raw: ");
    //     for( int i = 0 ; i < (sizeof(RawData.raw)/sizeof(RawData.raw[0])) ;
    //     ++i ){
    //       Serial.print(RawData.raw[i], 10);
    //       Serial.print(" ");
    //     }
    // Serial.print("\nRawData.quat: ");
    //     for( int i = 0 ; i < (sizeof(RawData.quat)/sizeof(RawData.quat[0])) ;
    //     ++i ){
    //       Serial.print(RawData.quat[i], 10);
    //       Serial.print(" ");
    //     }
    // Serial.print("\nRawData.ypr: ");
    //     for( int i = 0 ; i < (sizeof(RawData.ypr)/sizeof(RawData.ypr[0])) ;
    //     ++i ){
